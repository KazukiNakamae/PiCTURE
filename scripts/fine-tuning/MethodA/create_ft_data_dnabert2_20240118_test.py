...
file_pos = open("./dataset/positive/SRR11561324.hg38.identified.snp.fltr.CtoT.fa", "r")
file_neg = open("./dataset/negative/SRR11561289.hg38.identified.snp.fltr.CtoT.fa", "r")
...
with open("/Users/suzuki/Desktop/test.csv","w") as output_file:
